...
//                     <View style={{ flex: 1.5, backgroundColor: Color.buttonColor.enableButton }}>
...
//                                 onPress={() => {
//                                     if (this.isEmptyField(Session.sharedInstance.userDetails, Constants.userDetailsFields.isVerified) == true) {
//                                         this.screenChangeHandler(Constants.routeName.NotificationListScreen)

//                                     } else if (this.isEmptyField(Session.sharedInstance.userDetails, Constants.userDetailsFields.is_student) == true) {
//                                         this.screenChangeHandler(Constants.routeName.NotificationListScreen)
...
//                             <SideMenuRow
//                                 imageTintColor={Color.buttonColor.enableButton}
